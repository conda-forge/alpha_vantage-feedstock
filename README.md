...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/alpha_vantage-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11606&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/alpha_vantage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `alpha_vantage` can be installed with:

```
conda install alpha_vantage
```

It is possible to list all of the versions of `alpha_vantage` available on your platform with:
